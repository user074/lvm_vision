...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal_withdino(
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            if num_images == 0:
                cur_image_features = (0. * self.get_model().mm_projector(vision_tower.dummy_feature))
            ...
            for i in range(num_images + 1):
                ...
                if i < num_images:
                    ...
                    #here add the logic to fuse the clip and dino features together
                    num_patches, clip_dim = cur_image_features_clip.shape
                    clip_dtype = cur_image_features_clip.dtype
                    # Fuse features with element wise multiplication -- Need further investigation
                    merged_features = torch.empty(num_patches, clip_dim, dtype = clip_dtype)
                    merged_features = cur_image_features_clip * cur_image_features_dino
